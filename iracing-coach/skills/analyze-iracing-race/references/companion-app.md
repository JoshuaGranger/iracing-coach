...
- Raw IBTs, replays, STOs, and HTML exports are source artifacts. Keep them read-only. Raw IBTs remain in the iRacing telemetry directory; archive derived data, full channel catalogs, bounded profiles, reports, and verified fingerprints.
