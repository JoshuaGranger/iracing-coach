...
Implementation references: `App.xaml.cs`, `StartupRegistration.cs`, `CoachEngine.cs`, `McpBackendClient.cs`, `RuntimeMapper.cs`, and the MCP contracts under `companion-app-handoff/contracts/`.
