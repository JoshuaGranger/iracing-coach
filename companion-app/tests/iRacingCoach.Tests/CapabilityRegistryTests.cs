...
public sealed class CapabilityRegistryTests
{
    ...
    public void Corrective092_PrimaryWorkflowsContainTheQaRequiredImplementations()
    {
        ...
        StringAssert.Contains(coachCss, "grid-template-columns: 70px 42px minmax(144px,1fr) 38px 60px 28px 64px");
        StringAssert.Contains(coachCss, "grid-template-columns: 60px 36px minmax(124px,1fr) 36px 52px 26px 58px");
        ...
        StringAssert.Contains(coachCss, "grid-template-columns: minmax(422px,38%) minmax(0,1fr)");
        StringAssert.Contains(coachCss, "@container (max-width: 960px)");
        StringAssert.Contains(coachCss, "width: 100%; grid-template-columns: minmax(422px,38%) minmax(0,1fr); zoom: .75;");
