...
public static class AnalysisTraceLayouts
{
    ...
    [
        ...
        new("vertical-g", "Vertical G", "g", "acceleration", "Vert"),
        new("clutch", "Clutch", "%", "pedals", "C"),
        new("abs-active", "ABS active", "on / off", "pedals", "ABS"),
        new("abs-cut", "ABS intervention", "%", "pedals", "ABS cut"),
        new("brake-bias", "Brake bias", "%", "pedals", "Bias"),
        new("steering-torque", "Steering torque", "Nm", "rotation", "Torque"),
        new("pitch", "Pitch", "deg", "rotation", "Pitch"),
        new("roll", "Roll", "deg", "rotation", "Roll"),
        new("pitch-rate", "Pitch rate", "deg/s", "rotation", "Pitch"),
        new("roll-rate", "Roll rate", "deg/s", "rotation", "Roll"),
        new("lf-wheel-speed", "LF wheel speed", "mph", "tire", "LF"),
        new("rf-wheel-speed", "RF wheel speed", "mph", "tire", "RF"),
        new("lr-wheel-speed", "LR wheel speed", "mph", "tire", "LR"),
        new("rr-wheel-speed", "RR wheel speed", "mph", "tire", "RR"),
        new("lf-wheel-slip", "LF wheel slip", "%", "tire", "LF slip"),
        new("rf-wheel-slip", "RF wheel slip", "%", "tire", "RF slip"),
        new("lr-wheel-slip", "LR wheel slip", "%", "tire", "LR slip"),
        new("rr-wheel-slip", "RR wheel slip", "%", "tire", "RR slip"),
        new("lf-pressure", "LF pressure", "psi", "tire", "LF psi"),
        new("rf-pressure", "RF pressure", "psi", "tire", "RF psi"),
        new("lr-pressure", "LR pressure", "psi", "tire", "LR psi"),
        new("rr-pressure", "RR pressure", "psi", "tire", "RR psi"),
        new("lf-carcass-temp", "LF carcass temp", "deg F", "tire", "LF temp"),
        new("rf-carcass-temp", "RF carcass temp", "deg F", "tire", "RF temp"),
        new("lr-carcass-temp", "LR carcass temp", "deg F", "tire", "LR temp"),
        new("rr-carcass-temp", "RR carcass temp", "deg F", "tire", "RR temp"),
        new("lf-surface-temp", "LF surface temp", "deg F", "tire", "LF surf"),
        new("rf-surface-temp", "RF surface temp", "deg F", "tire", "RF surf"),
        new("lr-surface-temp", "LR surface temp", "deg F", "tire", "LR surf"),
        new("rr-surface-temp", "RR surface temp", "deg F", "tire", "RR surf"),
        new("fuel-level", "Fuel level", "gal", "fuel", "Fuel"),
        new("fuel-use-rate", "Fuel use rate", "kg/h", "fuel", "Fuel rate"),
        new("center-front-ride-height", "Front ride height", "in", "chassis", "Front RH"),
        new("lf-ride-height", "LF ride height", "in", "chassis", "LF RH"),
        new("rf-ride-height", "RF ride height", "in", "chassis", "RF RH"),
        new("lr-ride-height", "LR ride height", "in", "chassis", "LR RH"),
        new("rr-ride-height", "RR ride height", "in", "chassis", "RR RH"),
        new("lf-shock-deflection", "LF shock deflection", "in", "chassis", "LF shock"),
        new("rf-shock-deflection", "RF shock deflection", "in", "chassis", "RF shock"),
        new("lr-shock-deflection", "LR shock deflection", "in", "chassis", "LR shock"),
        new("rr-shock-deflection", "RR shock deflection", "in", "chassis", "RR shock"),
        new("lf-shock-velocity", "LF shock velocity", "in/s", "chassis", "LF vel"),
        new("rf-shock-velocity", "RF shock velocity", "in/s", "chassis", "RF vel"),
        new("lr-shock-velocity", "LR shock velocity", "in/s", "chassis", "LR vel"),
        new("rr-shock-velocity", "RR shock velocity", "in/s", "chassis", "RR vel"),
        new("track-temperature", "Track temperature", "deg F", "conditions", "Track"),
        new("air-temperature", "Air temperature", "deg F", "conditions", "Air"),
        new("wind-speed", "Wind speed", "mph", "conditions", "Wind"),
        new("humidity", "Humidity", "%", "conditions", "Humidity"),
        new("fog", "Fog", "%", "conditions", "Fog"),
        new("precipitation", "Precipitation", "%", "conditions", "Rain"),
        new("air-pressure", "Air pressure", "inHg", "conditions", "Pressure"),
        new("air-density", "Air density", "lb/ft3", "conditions", "Density"),
        new("track-wetness", "Track wetness", "state", "conditions", "Wetness"),
        new("track-usage", "Track usage", "%", "conditions", "Usage"),
        new("weather-wet", "Wet weather", "on / off", "conditions", "Wet"),
        new("overall-position", "Overall position", "position", "race", "Pos"),
        new("class-position", "Class position", "position", "race", "Class"),
        new("distance-ahead", "Distance ahead", "ft", "race", "Ahead"),
        new("distance-behind", "Distance behind", "ft", "race", "Behind"),
        new("on-pit-road", "On pit road", "on / off", "race", "Pit"),
        new("track-surface", "Track surface", "state", "race", "Surface")
    ];
