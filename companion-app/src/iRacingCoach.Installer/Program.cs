...
internal static class InstallerEngine
{
    ...
    private static void CacheRepairInstaller()
    {
        ...
        var destination = Path.Combine(cacheRoot, "iRacingCoach-0.14.1-Setup.exe");
    ...
    private static void IntegrateWithWindows(string target, bool desktopShortcut)
    {
        ...
        key.SetValue("DisplayName", "iRacing Coach"); key.SetValue("DisplayVersion", "0.14.1"); key.SetValue("Publisher", "iRacing Coach");
        ...
        key.SetValue("ModifyPath", $"\"{Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "iRacingCoach", "Installer", "iRacingCoach-0.14.1-Setup.exe")}\" --repair");
