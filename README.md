...
The latest stable packaged release is `0.14.2`; its immutable artifact record remains in [documentation/06-reality/implementation-snapshot-0.14.2.md](documentation/06-reality/implementation-snapshot-0.14.2.md). The current source identifies `0.15.0` development. An explicitly requested installer candidate has been built and lifecycle-tested for simulator feedback, but it is not yet a stable or user-accepted release and no portable package was produced. Its current reality is recorded in [documentation/06-reality/implementation-snapshot-0.15.0-development.md](documentation/06-reality/implementation-snapshot-0.15.0-development.md).
